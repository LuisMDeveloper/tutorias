	...
	@foreach ($errors->all('<div class="alert alert-danger"><span class="glyphicon glyphicon-minus-sign"></span>  :message</div>') as $error)
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title"><span class="glyphicon glyphicon-file"></span> Formato 1A Diagnostico Inicial</h3>
			</div>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						{{ Form::label('escuela_procedencia', 'Escuela de Procedencia:', array(
							'class' => 'col-sm-3 control-label'
						)) }}
						<div class="col-sm-9">
							{{ Form::text('escuela_procedencia', null, array( 
								'class' => 'form-control',
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						{{ Form::label('tipo_bachillerato', 'Tipo de Bachillerato:', array(
							'class' => 'col-sm-5 control-label'
						)) }}
						<div class="col-sm-7">
							{{ Form::text('tipo_bachillerato', null, array( 
								'class' => 'form-control',
					...
					<div class="form-group">
						{{ Form::label('promedio_admision', 'Promedio de examen de Admisión:', array(
							'class' => 'col-sm-5 control-label'
						)) }}
						<div class="col-sm-7">
							{{ Form::text('promedio_admision', null, array( 
								'class' => 'form-control',
								'placeholder' => 'Promedio de examen de Admisión'
							)) }}
						</div>
					</div> 
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						{{ Form::label('promedio_bachillerato', 'Promedio de Bachillerato:', array(
							'class' => 'col-sm-5 control-label'
						)) }}
						<div class="col-sm-7">
							{{ Form::text('promedio_bachillerato', null, array( 
								'class' => 'form-control',
								'placeholder' => 'Promedio de Bachillerato'
							)) }}
						</div>
					</div> 
					<div class="form-group">
						{{ Form::label('vive_con', 'Vive con:', array(
							'class' => 'col-sm-5 control-label'
						)) }}
						<div class="col-sm-7">
							{{ Form::text('vive_con', null, array( 
								'class' => 'form-control',
